...
[![Build Status](https://travis-ci.org/SublimeLinter/SublimeLinter-contrib-swiftlint.svg?branch=master)](https://travis-ci.org/SublimeLinter/SublimeLinter-contrib-swiftlint)
...
1. Install `swiftlint` by typing the following in a terminal:
   ```
...
Once you have installed and configured `swiftlint`, you can proceed to install the SublimeLinter-contrib-swiftlint plugin if it is not yet installed.
...
1. When the plugin list appears, type `swiftlint`. Among the entries you should see `SublimeLinter-contrib-swiftlint`. If that entry is not highlighted, use the keyboard or mouse to select it.
